        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-5 col-sm-offset-1 text-center">
                    ...
                    <a class="btn btn-block btn-raised btn-primary" href="{{route('signup')}}">Sign up here</a>
                    <br><br>
                    <h3 class="text-light">
                        or
                    </h3>
                    <p>
                        <a href="{{route('fblogin')}}" class="btn btn-block btn-raised btn-info"><i class="fa fa-facebook pull-left"></i>Login with Facebook</a>
                    </p>
                    <p>
                        <a href="{{route('gllogin')}}" class="btn btn-block btn-raised btn-info"><i class="fa fa-twitter pull-left"></i>Login with Google</a>
                    </p>
                </div><!--end .col -->
            </div><!--end .row -->
        </div><!--end .card-body -->
