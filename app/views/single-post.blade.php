...
<head>
    ...
    <meta property="og:site_name" content="Inshort" />
    ...
    <div class="row" style="min-height: 600px;">
        <div class="col m12 s12 l12 single-card">
            ...
            <div class="col l4 m4 s12">
                ...
                <a href="#" class="full-btn waves-effect waves-light btn light-blue darken-4"><i class="fa fa-facebook left"></i>Share on Facebook</a>
                <a href="#" class="full-btn waves-effect waves-light btn no-right-mar light-blue accent-3"><i class="fa fa-twitter left"></i>Share on Twitter</a>
            </div>
