...
@section('content')
    ...
    <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
        ...
        <ul>
            ...
            <li style="display: none"><a class="btn-floating yellow darken-1" href="{{route('adminContributorsManagement')}}" style="transform: scaleY(0.4) scaleX(0.4) translateY(40px); opacity: 0;"><i class="md md-visibility" style="line-height:40px;"></i></a></li>
