                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td style="width: 297px;">
                                    ...
                                    <a title="Send Push Notification" class="btn ink-reaction btn-floating-action btn-info" href="{{route('adminViewPost', array('id' => $post->share_cat,'data' => $post->link))}}"><i class="fa fa-eye"></i></a>
