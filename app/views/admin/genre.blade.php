            ...
            <div class="card-body">
                <table class="table no-margin">
                    ...
                    <tr>
                        ...
                        <td>{{$category->name}}</td>
                        <td>
                            <a class="btn ink-reaction btn-floating-action btn-info" href="{{route('adminAddGenre')}}"><i class="fa fa-plus"></i></a>
                            <a class="btn ink-reaction btn-floating-action btn-danger" href="{{route('adminDeleteGenre',array('id' => $category->id))}}"><i class="fa fa-trash"></i></a>
                            <a class="btn ink-reaction btn-floating-action btn-info" href="{{route('adminEditGenre', array('id' => $category->id))}}"><i class="fa fa-edit"></i></a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
