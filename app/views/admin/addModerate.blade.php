    ...
    <div class="col-md-12">
        <div class="card">
             <div class="card-head style-primary">
                    <header>{{ tr('add_moderators') }}</header>
                 </div>
            <div class="card-body">
               
                <form class="form" action="{{route('addModerateProcess')}}" method="post">
...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
    <a class="btn-floating btn-large red" href="{{route('adminModeratorManagement')}}">
