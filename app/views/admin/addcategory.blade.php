...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
    ...
    <ul>
        <li><a class="btn-floating yellow darken-1" href="{{route('adminCategory')}}" style="trform: scaleY(0.4) scaleX(0.4) trlateY(40px); opacity: 0;"><i class="md md-visibility" style="line-height:40px;"></i></a></li>

        <li><a class="btn-floating blue" href="{{route('addCategory')}}" style="trform: scaleY(0.4) scaleX(0.4) trlateY(40px); opacity: 0;"><i class="md md-add" style="line-height:40px;"></i></a></li>
