                ...
                <div class="col s12 m3">
                    <div class="card small" style="height: auto;">
                        ...
                        <div class="card-action"  style="position:inherit">
                           To Accept the Cast Details  &nbsp; <a class="btn ink-reaction btn-floating-action btn-primary" href="{{route('approveCastProcessMorderate',array('id' => $casting->id))}}"><i class="fa fa-check"></i></a>
                        </div>
                    </div>
